...
public class LiarGame extends AppCompatActivity {
    ...
    public String[][] array = {
            ...
            {"나루토","블리치","짱구","포켓몬스터","명탐정코난","아톰","원피스","암살교실","진격의 거인","하이큐",
                    "킹덤","이누야샤","원펀맨","드래곤볼","미키마우스","데스노트","유희왕","아따맘마","톰과 제리","슈퍼맨",
                    "쿵푸팬더","스머프","건담","손오공","플랜더스의 개","곰돌이 푸","뽀빠이","탑블레이드","방귀대장 뿡뿡이","미녀와 야수",
                    "슬램덩크","너의 이름은","오즈의 마법사","호두까기 인형","도라에몽","금색의 갓슈","그리스로마 신화","Why?","귀멸의 칼날","강철의 연금술사",
                    "식객","고스트 바둑왕","기생수","슈퍼마리오","방가방가 햄토리","은하철도 999","아기공룡 둘리","개구리 중사 캐로로","티미의 못말리는 수호천사","패트와 매트"
            }
